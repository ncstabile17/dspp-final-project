...
prediction_data <- combined_data %>% 
  ...
  mutate(ami_0_30 = if_else(total_proj_affordable == 0, 0, ami_0_30),
         ...
         market_rate_units = if_else(total_proj_affordable == 0, 0, market_rate_units),
         total_bedrooms = if_else(total_proj_affordable == 0, 0, total_bedrooms)
         )

set.seed(20201212)
# create a split object
predict_investment_split <- initial_split(data = prediction_data, prop = 0.75)
...
count(predict_investment_train, total_proj_affordable) %>% arrange(n)

# TODO: Keep working on feature engineering and building model
# TODO: Manually add ward data for missing ones?
