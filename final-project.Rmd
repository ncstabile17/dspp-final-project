...
prediction_data <- combined_data %>% 
  select(investment_address, ward, dc_residents_employed, num_cbes, total_bedrooms, ami_0_30, ami_31_50, ami_51_80, ami_81, market_rate_units, total_proj_investment, lihtc_amount, total_proj_affordable, total_funding_sources, investment_year, quadrant)
