...
for (row in 1:nrow(dc_housing_investment)) {
  if(duplicated(dc_housing_investment$investment_address[row])) {
    # this is going to be complicated, there has to be a better way
    for(obs in 1:nrow(dc_housing_investment)) {
      # yeah definitely not the right way to do this
    }
  }
